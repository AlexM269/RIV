...
// retourne paire : (paire taille = largeur,hauteur ; matrice image recadrée)
pair<pair<int,int>,cv::Mat> feature_size::extract(const string& fileIm){
   ...
   // imwrite("../saved_model.png",imVide);
    ...
    return make_pair(make_pair(largeur, hauteur),imVide);
}
